...
@Component({
  selector: 'app-db-broker-detail',
  templateUrl: './db-broker-detail.component.html',
  styleUrls: ['./db-broker-detail.component.scss']
})
export class DbBrokerDetailComponent implements OnInit {
	broker_id
	first_name
	last_name
	broker_number
  ...
  ngOnInit() {
	...
	clientProfile(investor){
		...
		sessionStorage.removeItem('click_investor')
