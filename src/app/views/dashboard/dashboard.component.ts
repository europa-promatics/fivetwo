...
export class DashboardComponent implements OnInit {
	...
	showCoparisonChart(){
		this.zone.runOutsideAngular(() => {
			...
			series.fill=am4core.color("#105170");
			// color change of line
			series.stroke = am4core.color("#105170");
			// color change of line
			...
			// series.tooltip.label.stroke = "red";
	...
	showName(item){
		...
		// return item.totalAmount =! 0 ?  item.product_name : ""
	}
