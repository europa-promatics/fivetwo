...
export class DbEditClientComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.InvestorID = environment.InvestorID; //image path
        this.InvestorSignBasePath = environment.InvestorSignBasePath; //image path
    ...
    getClientProfile() {
        this.authService.singleInvestor({
            ...
            if (data.success == 1) {
                ...
                this.RecordAdviceClient = data.data.LastName + " " + data.data.FirstName
                ...
                this.form.controls['LastName2'].setValue(data.data.spouse_data ? data.data.spouse_data.LastName : "");
                this.form.controls['FirstName2'].setValue(data.data.spouse_data ? data.data.spouse_data.FirstName : "");
                this.form.controls['IdNumber2'].setValue(data.data.spouse_data ? data.data.spouse_data.IdNumber : "");
                this.form.controls['CellNumber2'].setValue(data.data.spouse_data ? data.data.spouse_data.CellNumber : "");
                this.form.controls['Email2'].setValue(data.data.spouse_data ? data.data.spouse_data.Email : "");
                this.form.controls['HomeNumber2'].setValue(data.data.spouse_data ? data.data.spouse_data.HomeNumber : "");
                this.form.controls['WorkNumber2'].setValue(data.data.spouse_data ? data.data.spouse_data.WorkNumber : "");
                this.form.controls['HomeAddress2'].setValue(data.data.spouse_data ? data.data.spouse_data.HomeAddress : "");
                this.form.controls['PostalAddress2'].setValue(data.data.spouse_data ? data.data.spouse_data.PostalAddress : "");
                this.form.controls['TaxNumber2'].setValue(data.data.spouse_data ? data.data.spouse_data.TaxNumber : "");
                // this.form.controls['MaritalStatus2'].setValue(data.data.spouse_data.MaritalStatus);
                this.form.controls['BankName2'].setValue(data.data.spouse_data ? data.data.spouse_data.BankName : "");
                this.form.controls['BankNumber2'].setValue(data.data.spouse_data ? data.data.spouse_data.BankNumber : "");
                this.form.controls['AccountType2'].setValue(data.data.spouse_data ? data.data.spouse_data.AccountType : "");
                ...
                this.RecordAdviceClient = data.data.RecordAdviceClient ? data.data.RecordAdviceClient : this.RecordAdviceClient;
                this.DisclosureName = data.data.DisclosureName ? data.data.DisclosureName : this.DisclosureName;
                this.Year1 = data.data.Year1;
                this.Year2 = data.data.Year2;
                this.Year3 = data.data.Year3;
                this.Year4 = data.data.Year4;
                this.Year5 = data.data.Year5;
                this.Year6 = data.data.Year6;
    ...
    public BankDetailsForm(stepper: MatStepper) {
        ...
        if (this.bank_upload_id == null || !this.BankwebcamImage) {
            this.toastr.warning('Please upload atleast one document', 'Warning')
            return
        }
        var ext = this.fileext;
    ...
    public AddressForm(stepper: MatStepper) {
        ...
        if (this.address_upload_id == null || !this.AddresswebcamImage) {
            this.toastr.warning('Please upload atleast one document', 'Warning')
            return
        }
        var ext = this.fileext;
