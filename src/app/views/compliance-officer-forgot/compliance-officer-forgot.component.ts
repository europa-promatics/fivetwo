...
@Component({
  selector: 'app-compliance-officer-forgot',
  templateUrl: './compliance-officer-forgot.component.html',
  styleUrls: ['./compliance-officer-forgot.component.scss']
})
export class ComplianceOfficerForgotComponent implements OnInit {
	submit=false
